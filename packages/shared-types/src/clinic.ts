import { z } from "zod";
import { CLINIC_TYPES, PALETTE_COLOR_TOKENS } from "./enums";
...
export const createClinicSchema = z
  .object({
    ...
    // Opcional — se omitido, o serviço atribui a próxima cor da paleta por
    // índice (mesma lógica que hoje vive no front).
